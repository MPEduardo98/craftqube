...
import { signAccessToken, signRefreshToken }    from "@/features/auth/lib/jwt";
import { setAuthCookies }                       from "@/features/auth/lib/cookies";
import type { RegisterPayload, UsuarioPublico } from "@/features/auth/types/auth";
import { sendWelcomeEmail }                     from "@/shared/lib/email/send";
