  ...
  return (
    <header
      ...
      style={{
        ...
        borderBottom: `1px solid ${scrolled ? "rgba(23, 53, 128, 0.5)" : "rgba(23, 53, 128, 0.2)"}`,
    ...
    >
      ...
      <div
        ...
        style={{
          background: "linear-gradient(90deg, var(--color-cq-800), var(--color-cq-700), var(--color-cq-800))",
          color: "var(--color-cq-accent)",
          borderBottom: "1px solid rgba(0, 212, 255, 0.1)",
        }}
      >
        ⚡ ENVÍO GRATIS en pedidos mayores a $5,000 MXN · ISO 9001 CERTIFICADO · SOPORTE TÉCNICO 24/7
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            {/* Search */}
            <button
              className="hidden sm:flex items-center gap-2 px-4 py-2 rounded-sm text-sm transition-all duration-200"
              style={{
              ...
              onMouseEnter={(e) => {
                ...
                (e.currentTarget as HTMLElement).style.color = "var(--color-cq-200)";
              }}
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLElement).style.borderColor = "var(--color-cq-800)";
                (e.currentTarget as HTMLElement).style.color = "var(--color-cq-steel-400)";
              }}
            ...
            >
              ...
              <span className="hidden md:block font-mono text-xs tracking-wider">BUSCAR</span>
            </button>
          ...
          <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col gap-2">
            {[
              ...
              <Link
                ...
                className="px-4 py-3 rounded-sm text-sm font-semibold tracking-wider transition-colors"
                style={{
                  color: "var(--color-cq-200)",
