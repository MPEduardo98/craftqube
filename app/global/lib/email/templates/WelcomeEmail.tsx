...
export function WelcomeEmail({ nombre, verifyUrl }: WelcomeEmailProps) {
  return (
    <html>
      <head>
        <meta charSet="utf-8" />
                ...
                <tr>
                  <td style={{ padding: "48px 40px" }}>
                    ...
                    <p style={{
                      ...
                      Gracias por registrarte en Craftqube. Estamos emocionados de tenerte con nosotros.
                    </p>
                    ...
                    <p style={{
                      ...
                      Para completar tu registro y acceder a todas las funcionalidades, necesitamos verificar tu correo electrónico.
                    </p>
